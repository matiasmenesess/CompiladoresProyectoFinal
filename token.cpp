...
std::ostream& operator<<(std::ostream& outs, const Token& tok) {
    switch (tok.type) {
        ...
        // Pointers
        case Token::POINTER: outs << "POINTER"; break;
        ...
        // Preprocessor
        case Token::PREPROCESSOR: outs << "PREPROCESSOR"; break;
        case Token::HEADER_NAME: outs << "HEADER_NAME"; break;

        // Comments
        case Token::LINE_COMMENT: outs << "LINE_COMMENT"; break;
        case Token::START_COMMENT_BLOCK: outs << "START_COMMENT_BLOCK"; break;
        case Token::END_COMMENT_BLOCK: outs << "END_COMMENT_BLOCK"; break;
